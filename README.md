...
1. Upload the `shipped-order-tracking-for-woocommerce` folder to `/wp-content/plugins/`
...
- GitHub: https://github.com/milangru/Shipped-Order-Tracking-for-WooCommerce
...
1. Copy `languages/shipped-order-tracking-for-woocommerce.pot`
2. Rename to your language (e.g., `shipped-order-tracking-for-woocommerce-sr_RS.po`)
...
Plugin URI: https://github.com/milangru/Shipped-Order-Tracking-for-WooCommerce
